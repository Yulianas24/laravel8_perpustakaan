    <div class="container">
        ...
        <div class="row border-bottom mb-5">
            <div class="col-md-8 mb-3">
                <h3>PERPUSTAKAAN SMA N 1 SUMPIUH</h3>
            </div>
            @if (!$detail_buku)
            <div class="col-md-4">
                <label class="sr-only" for="inlineFormInputGroup">Username</label>
                <div class="input-group mb-2">
                    <p class=" nav-link  text-dark" id="kategori">{{$title}} </p>
                    <livewire:peminjam.kategori></livewire:peminjam.kategori>
                    <input wire:model="search" class="form-control me-2 ml-2" type="search" placeholder="Cari Buku">
                </div>
            </div>
            @endif
        </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div wire:click="detailBuku({{$item->id}})" class="card mb-4 shadow" style="cursor: pointer">
                    <img src="/storage/{{$item->sampul}}" class="card-img-top" alt="{{$item->judul}}" width="200"
                        height="300">
                    <div class="card-body">
